...
vi.mock("@fiftyone/state", () => ({
  ...
  useStableActiveFo3dSlice: () => mockState.group3dState.activeFo3dSlice,
  useActiveDirectSlices: () => mockState.group3dState.activeDirectSlices,
  useActive3dSlices: () => mockState.group3dState.activeSlices,
  useStableActive3dSamplesMap: () => mockState.group3dState.activeSampleMap,
  useStableAll3dSamplesMap: () => mockState.group3dState.allSampleMap,
  useStableRealFo3dSlices: () => mockState.group3dState.realFo3dSlices,
